...
echo Actualizando...
echo.
"%programfiles%\Kaspersky Lab\Kaspersky Anti-Virus 2013\avp.com" update 
...
"%programfiles%\TeraCopy\TeraCopy.exe" Move "%userprofile%\Desktop\kaspersky.rar" D: /OverwriteAll
...
rem MOVE /Y "%userprofile%\Desktop\kaspersky.rar" D:
echo.
pause 
:End
exit